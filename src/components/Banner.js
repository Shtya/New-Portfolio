    ...
    <div className='container mx-auto min-h-[100vh] all:justify-center  relative flex  items-center    ' >
      <div className='flex justify-center  items-center   all:flex-col all:gap-4'>
        <div className='flex-1' >
          ...
          <br/>
          <motion.h3 variants={fadeIn("up",0.6)} initial="hidden" whileInView={'show'} viewport={{once:false , amount:0.7}}  className='max-w-[600px]  text-zinc-400 italic pr  '>  I'm a Freelance Fullstack Developer with over 2 years of  experience.</motion.h3>
        ...
        <motion.img variants={fadeIn("down",0.6)} initial="hidden" whileInView={'show'} viewport={{once:false , amount:0.7}}  className='one all:mb-[40px] smd:w-[300px] smd:h-[300px] ' src={Image} />
        <br/>
      </div>
